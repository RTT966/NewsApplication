...
final class NewsNetworkManager: NewsServiceType {
    ...
    func fetchTopHeadlines() -> Observable<[NewViewModel]> {
        let art = [Article(author: "Jack", title: "SOme", description: "SOme", url: "SOme", urlToImage: "SOM", publishedAt: "ehh"),Article(author: "Jack", title: "SOme", description: "SOme", url: "SOme", urlToImage: "SOM", publishedAt: "ehh"),Article(author: "Jack", title: "SOme", description: "SOme", url: "SOme", urlToImage: "SOM", publishedAt: "ehh"),Article(author: "Jack", title: "SOme", description: "SOme", url: "SOme", urlToImage: "SOM", publishedAt: "ehh"),]
